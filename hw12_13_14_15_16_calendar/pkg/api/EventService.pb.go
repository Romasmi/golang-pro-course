...
type Event struct {
	...
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // Output only. Generated by the server.
...
const file_EventService_proto_rawDesc = "" +
	...
	"\x04YEAR\x10\x032\xcb\x04\n" +
	"\fEventService\x12_\n" +
	"\vCreateEvent\x12\x19.event.CreateEventRequest\x1a\x1a.event.CreateEventResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x05event\"\n" +
	"/v1/events\x12j\n" +
	"\vUpdateEvent\x12\x19.event.UpdateEventRequest\x1a\x1a.event.UpdateEventResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x05event\x1a\x15/v1/events/{event.id}\x12T\n" +
	"\bGetEvent\x12\x16.event.GetEventRequest\x1a\x17.event.GetEventResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/events/{id}\x12U\n" +
	"\n" +
	"ListEvents\x12\x18.event.ListEventsRequest\x1a\x19.event.ListEventsResponse\"\x12\x82\xd3\xe4\x93\x02\f\x12\n" +
	"/v1/events\x12}\n" +
	"\x14ListEventsByInterval\x12\".event.ListEventsByIntervalRequest\x1a\x19.event.ListEventsResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/v1/events/interval/{interval}\x12B\n" +
