...
const (
	...
	EventService_ListEventsByInterval_FullMethodName = "/event.EventService/ListEventsByInterval"
	EventService_Hello_FullMethodName                = "/event.EventService/Hello"
)
...
type EventServiceClient interface {
	...
	ListEventsByInterval(ctx context.Context, in *ListEventsByIntervalRequest, opts ...grpc.CallOption) (*ListEventsResponse, error)
...
func (c *eventServiceClient) ListEventsByInterval(ctx context.Context, in *ListEventsByIntervalRequest, opts ...grpc.CallOption) (*ListEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListEventsResponse)
	err := c.cc.Invoke(ctx, EventService_ListEventsByInterval_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, EventService_Hello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventServiceServer interface {
	...
	ListEventsByInterval(context.Context, *ListEventsByIntervalRequest) (*ListEventsResponse, error)
...
func (UnimplementedEventServiceServer) ListEventsByInterval(context.Context, *ListEventsByIntervalRequest) (*ListEventsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEventsByInterval not implemented")
}
func (UnimplementedEventServiceServer) Hello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _EventService_ListEventsByInterval_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListEventsByIntervalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventServiceServer).ListEventsByInterval(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_ListEventsByInterval_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).ListEventsByInterval(ctx, req.(*ListEventsByIntervalRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EventService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventServiceServer).Hello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_Hello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).Hello(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListEventsByInterval",
			Handler:    _EventService_ListEventsByInterval_Handler,
		},
		{
			MethodName: "Hello",
			Handler:    _EventService_Hello_Handler,
		},
	},
